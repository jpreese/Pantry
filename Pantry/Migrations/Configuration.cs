...
namespace Pantry.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Pantry.Context.RecipesContext>
    {
        ...
        protected override void Seed(Pantry.Context.RecipesContext context)
        {
